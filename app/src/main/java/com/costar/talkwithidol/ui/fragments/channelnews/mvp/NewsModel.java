...
public class NewsModel {
    ...
    public Observable<ExploreNewsResponse> getChannelNewsObservable(int page, String id, String cookie) {

        String url = Constants.CHANNELNEWS + id + "/news" + "?page=" + page;
        return padloktNetwork.getChannelNews(url, cookie);
    }
