...
public class EventDtailModel {

    private final PadloktNetwork padloktNetwork;
    private AppCompatActivity activity;
private PreferencesManager preferencesManager;

    public EventDtailModel(AppCompatActivity activity, PadloktNetwork padloktNetwork, PreferencesManager preferencesManager) {
    ...
    public Observable<SubmitQuestionResponse> submitQuestion(QuestionParams questionParams) {
        return padloktNetwork.submitQestion(EventDtailActivity.videoId, questionParams,preferencesManager.get(Constants.TOKEN), preferencesManager.get(Constants.COOKIE));
    }
