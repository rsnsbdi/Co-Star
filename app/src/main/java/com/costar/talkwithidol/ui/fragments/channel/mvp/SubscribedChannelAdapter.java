...
public class SubscribedChannelAdapter extends RecyclerView.Adapter<SubscriptionViewHolder> {

    ChannelSubscriptionResponse channelSubscriptionResponse;
    Activity activity;
    private PublishSubject<SubscribedChannel> clickToggle = PublishSubject.create();

    private List<SubscribedChannel> arrayList = new ArrayList<>();
    ...
    public void showList(ChannelSubscriptionResponse channelSubscriptionResponse, Activity activity) {
        ...
        this.arrayList = channelSubscriptionResponse.getData().getSubscribedChannels();
    ...
    public void onBindViewHolder(SubscriptionViewHolder holder, int position) {
        ...
        holder.binding.toggleButton.setImageDrawable(activity.getDrawable(R.drawable.toggle_on));

    }

    public Observable<SubscribedChannel> getToggleClickObservable() {
        return clickToggle;
    }
