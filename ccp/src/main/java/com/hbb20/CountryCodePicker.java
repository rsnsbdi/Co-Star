...
public class CountryCodePicker extends RelativeLayout {
    ...
    static int LIB_DEFAULT_COUNTRY_CODE = 61;
    ...
    private void applyCustomProperty(AttributeSet attrs) {
        ...
        try {
            ...
            if (isInEditMode()) {
                ...
                contentColor = a.getColor(R.styleable.CountryCodePicker_ccp_contentColor, context.getResources().getColor(android.R.color.white));
            }
            if (contentColor != 0) {
